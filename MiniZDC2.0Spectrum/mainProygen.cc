...
//auto runManager= new G4RunManager();
	...
	G4OpticalPhysics *optfisic = new G4OpticalPhysics();
	
	fisica->RegisterPhysics(optfisic);
	auto optPar = G4OpticalParameters::Instance();
	optPar->SetProcessActivation("Scintillation",true);
	optPar->SetProcessActivation("Cerenkov",false);
	optPar->SetProcessActivation("OpRayleigh",false);
	optPar->SetProcessActivation("OpMieHG",false);
	optPar->Dump();
